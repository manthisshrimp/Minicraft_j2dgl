...
import minicraftj2dgl.crafting.Recipe;
...
public class CraftingMenu extends Menu {
    ...
    public CraftingMenu(List<Recipe> recipes, Player player, Game game, InputHandler inputHandler) {
        ...
        Collections.sort(this.recipes, (Recipe r1, Recipe r2) -> {
